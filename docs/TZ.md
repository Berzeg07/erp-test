...
- `POST /cases/apply-policy` — deliveryGuard (opt-out / suppression / injection / basis); затем rules-v1 и mock-LLM
- `POST /cases/apply-rules` — `rules-v1` на все карточки tenant, затем mock-LLM
